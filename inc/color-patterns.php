 ...
 */
function ozarcgas_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Ozarc Gas default saturation level.
	 *
	 * @since Ozarc Gas 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'ozarcgas_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ozarcgas-front-page) .entry-title,
...
.colors-custom .ozarcgas-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ozarcgas-front-page .panel-content .recent-posts article,
...
.colors-custom.ozarcgas-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Ozarc Gas custom colors CSS.
	 *
	 * @since Ozarc Gas 1.0
	 *
	 ...
	 */
	return apply_filters( 'ozarcgas_custom_colors_css', $css, $hue, $saturation );
}
